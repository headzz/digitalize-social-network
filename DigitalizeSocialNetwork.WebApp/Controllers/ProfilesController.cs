...
using DigitalizeSocialNetwork.DataAccess.Repositories;
using DigitalizeSocialNetwork.DomainModel.Entities;
using DigitalizeSocialNetwork.DomainModel.Interfaces.Repositories;
using DigitalizeSocialNetwork.DomainService;

namespace DigitalizeSocialNetwork.WebApp.Controllers
{
    public class ProfilesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            client.BaseAddress = new Uri("https://digitalizenetworkwebapp.azurewebsites.net");
